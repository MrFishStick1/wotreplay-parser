...
static boost::container::flat_map<int, std::vector<std::tuple<float, float>>> getTeamPositions(XMLElement *teamPointsNode) {
    boost::container::flat_map<int, std::vector<std::tuple<float, float>>> team_positions;
...
static boost::container::flat_map<std::string, arena_configuration_t> getArenaConfigurations(XMLElement *gameplayTypesNode) {
...
static boost::container::flat_map<std::string, arena_t> get_arena_definitions() {
    // xmlInitParser();
    boost::container::flat_map<std::string, arena_t> arenas;
...
static boost::container::flat_map<std::string, arena_t> arenas;
...
const boost::container::flat_map<std::string, arena_t> &wotreplay::get_arenas() { return arenas; }
